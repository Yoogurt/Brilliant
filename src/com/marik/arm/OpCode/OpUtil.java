...
public class OpUtil {
	...
	/**
	 * cut the data down form "form" , the rest binary data length will be "length"
	 * 
	...
	public static String parseRegister(int no) {
		...
		case 15:
			return "PC";
		default:
			throw new IllegalArgumentException("Unable to decide register " + no);
		}
	}
	
	/**
	 * 	transform no into binary , and check the each index is 1 or not
	 * 	1 represents the R(index) register are specific
	 *  
	 * 	for instance : 0b 1  0  1  0  1  0
	 *  mean             R5    R3    R1
	 */
	public static String parseRigisterBit(int data) {
	...
	public static void main(String[] args) {
		System.out.println(getShiftInt(0b1010110 , 3,2));
	}
